package net.mcreator.brokenbad.world.features.treedecorators;
...
@EventBusSubscriber
public class MethHighBiomeLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<MethHighBiomeLeaveDecorator> CODEC = MapCodec.unit(MethHighBiomeLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("breaking_chemistry:meth_high_biome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public MethHighBiomeLeaveDecorator() {
		super(0.25f);
	}
