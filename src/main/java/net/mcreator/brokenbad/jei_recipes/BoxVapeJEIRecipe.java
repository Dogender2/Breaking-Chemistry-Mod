...
public class BoxVapeJEIRecipe implements Recipe<RecipeInput> {
	private final List<ItemStack> output;
	private final NonNullList<Ingredient> recipeItems;

	public BoxVapeJEIRecipe(List<ItemStack> output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Type implements RecipeType<BoxVapeJEIRecipe> {
		private Type() {
		}

		public static final RecipeType<BoxVapeJEIRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<BoxVapeJEIRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<BoxVapeJEIRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, BoxVapeJEIRecipe::new));
		public static final StreamCodec<RegistryFriendlyByteBuf, BoxVapeJEIRecipe> STREAM_CODEC = StreamCodec.of(Serializer::toNetwork, Serializer::fromNetwork);

		@Override
		public MapCodec<BoxVapeJEIRecipe> codec() {
			return CODEC;
		}

		@Override
		public StreamCodec<RegistryFriendlyByteBuf, BoxVapeJEIRecipe> streamCodec() {
			return STREAM_CODEC;
		}

		private static BoxVapeJEIRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
			...
			return new BoxVapeJEIRecipe(outputs, inputs);
		}

		private static void toNetwork(RegistryFriendlyByteBuf buf, BoxVapeJEIRecipe recipe) {
